...
exports.seed = async function(knex) {
  ...
  await knex('activities').insert([
    ...
    {name: 'Mike\'s TisBooked HQ', description: 'Not Travelocity', beach: boo(), mountain: boo(), forest: boo(), downtown: boo(), countryside: boo(), suburbia: boo(), meal: boo(), entertainment: boo(), social: boo(), before_sunrise: boo(), late_morning: boo(), noon: boo(), afternoon: boo(), evening: boo(), night: boo()},
    ...
    {...template(), name: 'Yang\'s "Voodoo" Aquarium', description: '???????????'},
